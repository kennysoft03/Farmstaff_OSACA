...
define('DB_SERVER_USERNAME', 'giftrete_gift');
define('DB_SERVER_PASSWORD', 'NL?kf*4{URdE');
define('DB_DATABASE', 'giftrete_gift');
...
define("SITE_URL", "https://giftrete.com/account/");
/* the page where you will be redirected for authorzation */
define("REDIRECT_URL", SITE_URL."google_login/");

/* * ***** Google related activities start ** */
define("CLIENT_ID", "276769163557-rfrri69d25kps5hpcodf1kgh4m3jsfih.apps.googleusercontent.com"); 
define("CLIENT_SECRET", "2_HBHmPye0hi_EhIpgvMXNTy");
