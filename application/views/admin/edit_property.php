...
<head>
    ...
    <title>Edit Property - Steavek Properties</title>
    ...
    <div class="container mt-4">
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="price" name="price" step="0.01" value="<?php echo $property['price']; ?>" required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <select class="form-control" id="category" name="category" required>
                    ...
                    <option value="land" <?php echo ($property['category'] == 'land') ? 'selected' : ''; ?>>Land</option>
                    <option value="commercial" <?php echo ($property['category'] == 'commercial') ? 'selected' : ''; ?>>Commercial</option>
                </select>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="features" name="features" rows="3"><?php echo $property['features']; ?></textarea>
            </div>
            <div class="mb-3">
                <label for="video_url" class="form-label">Video URL</label>
                <input type="url" class="form-control" id="video_url" name="video_url" value="<?php echo $property['video_url']; ?>">
            </div>
            <div class="mb-3">
                ...
                <div class="row">
                    <?php if (!empty($images)): ?>
                        <?php foreach ($images as $image): ?>
                            <div class="col-md-3">
                                <img src="<?php echo base_url($image['image_url']); ?>" class="img-thumbnail" alt="Property Image" style="max-height: 200px; max-width: 100%;">
                            </div>
                        <?php endforeach; ?>
                    <?php else: ?>
            ...
            <div class="mb-3">
                <label for="images" class="form-label">Upload New Images (will replace existing)</label>
                <input type="file" class="form-control" id="images" name="images[]" multiple accept="image/*" onchange="previewImages(event)">
                <small class="form-text text-muted">Leave empty to keep existing images</small>
            </div>
    ...
    <script>
        function previewImages(event) {
            ...
            if (files.length > 0) {
                ...
                previewTitle.textContent = 'New Image Preview (' + files.length + ' file(s))';
